...
class ProveedorContactoGestorCarga(AuditMixin, Base):
    """
    Defines the proveedor - contacto - gestor carga model
    """
    ...
    proveedor = relationship(Proveedor, uselist=False, back_populates="contactos")
