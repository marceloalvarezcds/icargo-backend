...
class RemitenteContactoGestorCarga(AuditMixin, Base):
    """
    Defines the remitente - contacto - gestor carga model
    """
    ...
    remitente = relationship(Remitente, uselist=False, back_populates="contactos")
