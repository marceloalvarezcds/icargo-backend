...
class PuntoVentaContactoGestorCarga(AuditMixin, Base):
    """
    Defines the punto_venta - contacto - gestor carga model
    """
    ...
    punto_venta = relationship(PuntoVenta, uselist=False, back_populates="contactos")
