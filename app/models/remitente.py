...
class Remitente(AuditMixin, Base):
    """
    Defines the remitentes model
    """
    ...
    contactos = relationship("RemitenteContactoGestorCarga", back_populates="remitente")
    gestores = relationship("GestorCargaRemitente", back_populates="remitente")
