    ...
    if status == EstadoEnum.INACTIVO:
        ...
        for combinacion in combinaciones_relacionadas:
            ...
            if (
                ...
                combinacion.propietario and combinacion.propietario.estado == EstadoEnum.ACTIVO.value and
                combinacion.chofer and combinacion.chofer.estado == EstadoEnum.ACTIVO.value
            ):
